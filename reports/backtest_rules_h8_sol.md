...
| gate_exit_chop:exit=50,lookback=60,max_cross=3 | +1668.47% | +147.54% | -49.44% | 2.98 | 1.34 | 26 | 8.2 | FAIL(mdd) |
...
| gate_exit_chop:exit=50,lookback=60,max_cross=3 | -14.51% | -9.73% | -48.87% | -0.20 | -0.21 | 17 | 11.1 | FAIL(return,mdd,calmar) |
...
| gate_exit_chop:exit=50,lookback=60,max_cross=3 | +23.06% | +69.30% | -10.32% | 6.72 | 2.41 | 0 | 0.0 | PASS |
